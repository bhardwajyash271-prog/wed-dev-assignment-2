...
<head>
  ...
  <title>My Portfolio | yash bhardwaj</title>
  <!-- External CSS Link -->
...
<body>
  ...
  <main id="main-content">
    ...
    <section id="about">
      <h2>About Me</h2>
      <img src="yash bhardwaj.jpg" alt="Profile photo of yash bhardwaj" class="profile">
      <p>Hello! I am yash bhardwaj, a passionate web development student who enjoys creating simple and responsive web pages using HTML, CSS, and JavaScript.</p>
    </section>
  ...
  <footer>
    <p>&copy; 2025 yash bhardwaj. All rights reserved.</p>
  </footer>
